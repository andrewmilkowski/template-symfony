...
// date: 2010/09/18 16:04:53
  ...
  'cache_dir' => '/opt/local/src/svn/php/template-symfony/git/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/local/src/svn/php/template-symfony/git/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/local/src/svn/php/template-symfony/git/cache/frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/opt/local/src/svn/php/template-symfony/git/apps/frontend/template',
)));
